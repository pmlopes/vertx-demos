 ...
 */
package io.vertx.devoxx.map.render.backend;

import static io.vertx.devoxx.map.mercator.Mercator.coord2xy;
import static io.vertx.devoxx.map.mercator.Mercator.tile2latlon;
...
import io.vertx.devoxx.map.BoundingBox;
import io.vertx.devoxx.map.Coordinate;
import io.vertx.devoxx.map.MapException;
import io.vertx.devoxx.map.mercator.Mercator;
import io.vertx.devoxx.map.rules.Draw;
import io.vertx.devoxx.map.rules.Rule;
import io.vertx.devoxx.map.rules.RuleSet;
import io.vertx.devoxx.map.source.MapSource;
import io.vertx.devoxx.map.source.Node;
import io.vertx.devoxx.map.source.Way;
